    ...
    <Box>
      ...
      <Container maxWidth="md" sx={{ py: 8 }}>
        ...
        <Typography variant="body1" sx={{ textAlign: 'center', mb: 6 }}>
          SOFTWERTICH is a company specialized in cybersecurity. A true key player in the global market, Softwaretich holds a strategic position in the cybersecurity ecosystem, thanks to a pool of advanced skills and unique expertise.
        </Typography>
